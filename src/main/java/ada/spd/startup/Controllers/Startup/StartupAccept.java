...
public class StartupAccept {
    ...
    public StartupAccept(StartupRepository startupRepository, UserRepository userRepository) {
        this.startupRepository = startupRepository;
        this.userRepository = userRepository;
    }

    @RequestMapping(value = "startup/{id}/accept/{uid}")
    public String acceptStartup(@PathVariable String id,@PathVariable String uid) {
